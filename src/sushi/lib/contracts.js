  ...
  constructor(provider, networkId, web3, options) {
    ...
    this.pools = supportedPools.map((pool) =>
      Object.assign(pool, {
        ...
        priceAddress: pool.priceAddress[networkId],

        lpContract: new this.web3.eth.Contract(UNIV2PairAbi), //LP
        tokenContract: new this.web3.eth.Contract(ERC20Abi),
        priceContract: new this.web3.eth.Contract(UNIV2PairAbi), //LP
      }),
    )
  ...
  setProvider(provider, networkId) {
    const setProvider = (contract, address) => {
      ...
      if (address) contract.options.address = address
        ...
        console.error(
          'Contract address not found in network,address',
          networkId,
          address,
        )
    }
    ...
    this.pools.forEach(
      ({
        ...
        setProvider(priceContract, priceAddress)
      },
    )
  }
